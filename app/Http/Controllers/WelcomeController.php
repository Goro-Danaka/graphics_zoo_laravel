	...
	*/
    ...
    public function index() {
        ...
        $portfolios = DB::table('portfolios')                            
                ...
                ->select('portfolios.*', 'portfolio_images.*')
                ->orderBy('portfolios.created', 'desc')
                ->get();
        ...
        return view('welcome/pages/index', ['portfolios' => $portfolios, 'posts' => $posts, 'page_title' => $page_title, 'body_class' => $body_class]);
    }

    public function aboutus() {
    	$page_title = 'About Us';
    	return view('welcome/pages/aboutus',  ['page_title' => $page_title]);
    }
